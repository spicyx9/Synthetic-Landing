...
Code inspected: js/motion.js and css/motion.css, all four choreography modules, homepage and Solution HTML/CSS/JS, js/mobile-menu.js, css/floating-demo.css and js/pages/home-floating-demo.js, shared layout generator, README, docs/BRAND.md and tests.
