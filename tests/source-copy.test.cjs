...
const infrastructureCopy = /\b(?:REDACTED|REDACTED|REDACTED|REDACTED|REDACTED)\b|REDACTED|voir les sources|view sources|scraping|registries|registres|databases|bases? de données/iu;
